...
@section('content')
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        <td>{{$pr->likes}}</td>
                        <td>
                        <button type="button" class="btn btn-info" onClick="detail({{ $pr->id }})">
      ...
      <script>
        ...
        function create() {
            $.get("{{ url('dataproduk/create') }}", {}, function(data, status) {
        ...
        function show(id) {
            $.get("{{ url('dataproduk/show') }}/"+ id, {}, function(data, status) {
        ...
        function detail(id) {
            $.get("{{ url('dataproduk/detail') }}/"+ id, {}, function(data, status) {
                $("#exampleModalLabel").html('Ubah Product')
                $("#page").html(data);
                $("#exampleModal").modal('show');
