                    <form class="form form-horizontal mb-4" action="{{ route('dataproduk.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                          ...
                          <input type="text" id="ratingproduk" name="ratingproduk" class="form-control" placeholder="Enter Rating" required />
                        </div>
                        <div class="mb-2">
                          <label for="nameWithTitle" class="form-label">Likes</label>
                          <input type="text" id="likesproduk" name="likesproduk" class="form-control" placeholder="Enter Likes" required />
                        </div>
                        <div class="mb-2">
